...
void setup() {
  ...
  rockknop = cp5
    ...
    .setColorActive(color(235, 64, 52))
    .setColorForeground(color(145, 15, 6));
...
void draw() {
  ...
  textSize(20);
  textAlign(LEFT);
  text("Jouw wins:", 50, 30);
  text("Gelijkspel:", 350, 30);
  text("CPU wins:", 650, 30);
  textAlign(CENTER);
  text(winCheck, 100, 60);
  text(drawCheck, 400, 60);
  text(CPUwinCheck, 700, 60);
  textSize(30);
}
...
//doe bij drawingCheck == 0 een plaatje van twee personen (jij en CPU)

void teken() {
  if (drawingCheck == 0) {
    text("Kies uit Steen, Papier of Schaar.", 400, 500);
    person();
    pc();
  } else if (drawingCheck == 1) {
    text("Gelijkspel!", 400, 500);
    text("Klik op Restart om de score te resetten.", 400, 590);
    rockhand();
    rockCPUhand();
  } else if (drawingCheck == 2) {
    text("Je hebt verloren van papier!", 400, 500);
    text("Klik op Restart om de score te resetten.", 400, 590);
    rockhand();
    paperCPUhand();
  } else if (drawingCheck == 3) {
    text("Je hebt gewonnen met steen!", 400, 500);
    text("Klik op Restart om de score te resetten.", 400, 590);
    rockhand();
    scissorsCPUhand();
  } else if (drawingCheck == 4) {
    text("Je hebt gewonnen met papier!", 400, 500);
    text("Klik op Restart om de score te resetten.", 400, 590);
    paperhand();
    rockCPUhand();
  } else if (drawingCheck == 5) {
    text("Gelijkspel!", 400, 500);
    text("Klik op Restart om de score te resetten.", 400, 590);
    paperhand();
    paperCPUhand();
  } else if (drawingCheck == 6) {
    text("Je hebt verloren van schaar!", 400, 500);
    text("Klik op Restart om de score te resetten.", 400, 590);
    paperhand();
    scissorsCPUhand();
  } else if (drawingCheck == 7) {
    text("Je hebt verloren van steen!", 400, 500);
    text("Klik op Restart om de score te resetten.", 400, 590);
    scissorshand();
    rockCPUhand();
  } else if (drawingCheck == 8) {
    text("Je hebt gewonnen met schaar!", 400, 500);
    text("Klik op Restart om de score te resetten.", 400, 590);
    scissorshand();
    paperCPUhand();
  } else if (drawingCheck == 9) {
    text("Gelijkspel!", 400, 500);
    text("Klik op Restart om de score te resetten.", 400, 590);
    scissorshand();
    scissorsCPUhand();
...
void CPU() {
  CPUrg = (int) random(1, 4);
  if (rock == 1 && CPUrg == 1) {
    drawingCheck = 1;
    drawCheck++;
  } else if (rock == 1 && CPUrg == 2) {
    drawingCheck = 2;
    CPUwinCheck++;
  } else if (rock == 1 && CPUrg == 3) {
    drawingCheck = 3;
    winCheck++;
  } else if (paper == 1 && CPUrg == 1) {
    drawingCheck = 4;
    winCheck++;
  } else if (paper == 1 && CPUrg == 2) {
    drawingCheck = 5;
    drawCheck++;
  } else if (paper == 1 && CPUrg == 3) {
    drawingCheck = 6;
    CPUwinCheck++;
  } else if (scissors == 1 && CPUrg == 1) {
    drawingCheck = 7;
    CPUwinCheck++;
  } else if (scissors == 1 && CPUrg == 2) {
    drawingCheck = 8;
    winCheck++;
  } else if (scissors == 1 && CPUrg == 3) {
    drawingCheck = 9;
    drawCheck++;
  }
}
...
//Hier volgen alle methodes die gebruikt zijn om de handen te tekenen. Er is niet echt iets speciaals aan de hand hier, het zijn gewoon een heleboel lijnen. Hoe ik die lijnen verkregen heb staat in een andere .pde, inbegrepen in dezelfde GitHub folder waar deze opdracht ook meegeleverd is.
